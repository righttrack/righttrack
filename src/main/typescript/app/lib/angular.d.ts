 ...
 *
 * The following type signatures have been updated to the latest version of Angular:
 *
 *
 *
 * This file based on:
...
declare module ng {
    ...
    export interface IJQLiteOrBetter extends JQuery { }
...
*/
    ...
    export interface ILacaleDateTimeFormatDescriptor {
        MONTH: string[];
        SHORTMONTH: string[];
        DAY: string[];
        SHORTDAY: string[];
    ...
    ///////////////////////////////////////////////////////////////////////////
    export interface IRootElementService extends IJQLiteOrBetter {}
    ...
    export interface IDestructuredResponse {
        data: any;
        status: number;
    ...
    export interface IRouteProviderProvider extends IServiceProvider {
